...
public class visualizarVeiculo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Enviar para Manutenção");

        jButton2.setText("Editar Veiculo");

        jLabel4.setText("foto");

        jButton3.setText("Voltar");

        jButton4.setText("Apagar Veiculo");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new visualizarVeiculo().setVisible(true);
            }
        });
    }
